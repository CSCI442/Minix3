...
/*Pre-allocate memory for storing process table information to be used in the OS visualization GUI */
struct proc ptab[NR_TASKS + NR_PROCS];
struct kinfo sysInfo;
#define ALL_PROCS 261 
/*===========================================================================*
 *				get_free_pid				     *
 *===========================================================================*/
pid_t get_free_pid()
